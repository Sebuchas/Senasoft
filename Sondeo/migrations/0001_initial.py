    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icono', models.ImageField(upload_to='media/')),
                ('estado', models.BooleanField(default=True)),
                ('idTema', models.ForeignKey(db_column='idTema', on_delete=django.db.models.deletion.CASCADE, to='Sondeo.tema')),
            ],
        ),
        migrations.CreateModel(
            name='Pregunta',
            fields=[
                ...
                ('idParametro', models.ForeignKey(db_column='Parametros', on_delete=django.db.models.deletion.CASCADE, to='Sondeo.parametro')),
        ...
        migrations.AddField(
            ...
            name='idSondeo',
            field=models.ForeignKey(db_column='idSondeo', on_delete=django.db.models.deletion.CASCADE, to='Sondeo.sondeo', verbose_name='Sondeo'),
        ),
        migrations.CreateModel(
            name='Certificacion',
            fields=[
